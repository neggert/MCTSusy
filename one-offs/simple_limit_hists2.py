...
m1_high = 475+bin_spacing/2
m2_low = 0-bin_spacing/2
m2_high = 400+bin_spacing/2
...
old_file = R.TFile("slep_limits_20130330.root")
fullHist = old_file.Get("hExpLimitSmooth")

fullHist.Divide(expected_hist)

fullHist.GetXaxis().SetTitle("mSlepton./")
...
import IPython
IPython.embed()
c1.SaveAs("slep_limit_ratio.png")
