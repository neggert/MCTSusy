...
result get_results(RooWorkspace* wspace, RooFitResult* res) {
    ...
    double sum_of_low = sum_tf->Integral(10, 300);
    double sum_of_low_err = sum_tf->IntegralError(10, 300, 0, res->reducedCovarianceMatrix(*sum_params_of).GetMatrixArray());
    double sum_of_high = sum_tf->Integral(300, 300);
    double sum_of_high_err = sum_tf->IntegralError(300, 300, 0, res->reducedCovarianceMatrix(*sum_params_of).GetMatrixArray());
    ...
    double top_of_low = top_tf->Integral(10, 300)/10;
    double top_of_low_err = top_tf->IntegralError(10, 300, 0, res->reducedCovarianceMatrix(*top_params).GetMatrixArray()) /10.;
    double top_of_high = top_tf->Integral(300, 300)/10;
    double top_of_high_err = top_tf->IntegralError(300, 300, 0, res->reducedCovarianceMatrix(*top_params).GetMatrixArray()) /10.;
    ...
    double vv_of_low = vv_tf->Integral(10, 300)/10;
    double vv_of_low_err = vv_tf->IntegralError(10, 300, 0, res->reducedCovarianceMatrix(*vv_params).GetMatrixArray()) /10.;
    double vv_of_high = vv_tf->Integral(300, 300)/10;
    double vv_of_high_err = vv_tf->IntegralError(300, 300, 0, res->reducedCovarianceMatrix(*vv_params).GetMatrixArray()) /10.;
    ...
    double z_of_low = z_tf->Integral(10, 300)/10;
    double z_of_low_err = z_tf->IntegralError(10, 300, 0, res->reducedCovarianceMatrix(*z_params).GetMatrixArray()) /10.;
    double z_of_high = z_tf->Integral(300, 300)/10;
    double z_of_high_err = z_tf->IntegralError(300, 300, 0, res->reducedCovarianceMatrix(*z_params).GetMatrixArray()) /10.;
    ...
    double fake_of_low = fake_tf->Integral(10, 300)/10;
    double fake_of_low_err = fake_tf->IntegralError(10, 300, 0, res->reducedCovarianceMatrix(*fake_params).GetMatrixArray()) /10.;
    double fake_of_high = fake_tf->Integral(300, 300)/10;
    double fake_of_high_err = fake_tf->IntegralError(300, 300, 0, res->reducedCovarianceMatrix(*fake_params).GetMatrixArray()) /10.;
